    ...
    <div className={`container max-w-5xl mx-auto m-8`}>
      ...
      <Divider />
        <div className={`flex flex-wrap border-4 border-indigo-600 border-opacity-50 rounded-lg p-8 shadow-xl`}>
            ...
            <p className={`text-gray-600 subpixel-antialiased font-light tracking-light leading-9 align-baseline leading-relaxed`}>
            ...
            <p className={`text-gray-800 subpixel-antialiased font-light tracking-light leading-9 align-baseline leading-relaxed`}>
            ...
            <p className={`text-gray-800 subpixel-antialiased font-bold tracking-light leading-8 align-baseline leading-relaxed text-primary font-bold mb-2 mt-2`}>
                O baralho não te diz o que você deseja mas aquilo que você precisa de ouvir.
            </p>
            <p className={`text-gray-600 subpixel-antialiased font-light tracking-light leading-9 align-baseline leading-relaxed`}>
            ...
            <ul className={`list-decimal text-gray-800 subpixel-antialiased font-light tracking-light leading-9 align-baseline leading-relaxed md:ml-4`}>
